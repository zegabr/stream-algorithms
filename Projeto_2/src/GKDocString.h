...
{
    const std::string DOC_STRING = "O algoritmo GK pode ser usado tanto para saber o rank de um determinado número dentro de uma stream de dados, quanto para saber o quantile de um valor.\n\n"
                                    "Execução:\n"
                                    "   gks [build_options] data_file.csv [rank | quant] [query_args | --in query_args_file]\n\n"
                                    "Build options:\n"
